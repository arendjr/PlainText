...
#define PT_FEC_1(WHAT, X) WHAT(X, 0)
#define PT_FEC_2(WHAT, X, ...) WHAT(X, 1) PT_FEC_1(WHAT, __VA_ARGS__)
#define PT_FEC_3(WHAT, X, ...) WHAT(X, 2) PT_FEC_2(WHAT, __VA_ARGS__)
#define PT_FEC_4(WHAT, X, ...) WHAT(X, 3) PT_FEC_3(WHAT, __VA_ARGS__)
#define PT_FEC_5(WHAT, X, ...) WHAT(X, 4) PT_FEC_4(WHAT, __VA_ARGS__)
#define PT_FEC_6(WHAT, X, ...) WHAT(X, 5) PT_FEC_5(WHAT, __VA_ARGS__)
#define PT_FEC_7(WHAT, X, ...) WHAT(X, 6) PT_FEC_6(WHAT, __VA_ARGS__)
#define PT_FEC_8(WHAT, X, ...) WHAT(X, 7) PT_FEC_7(WHAT, __VA_ARGS__)
#define PT_FEC_9(WHAT, X, ...) WHAT(X, 8) PT_FEC_8(WHAT, __VA_ARGS__)
#define PT_FEC_10(WHAT, X, ...) WHAT(X, 9) PT_FEC_9(WHAT, __VA_ARGS__)
#define PT_FEC_11(WHAT, X, ...) WHAT(X, 10) PT_FEC_10(WHAT, __VA_ARGS__)
#define PT_FEC_12(WHAT, X, ...) WHAT(X, 11) PT_FEC_11(WHAT, __VA_ARGS__)
#define PT_FEC_13(WHAT, X, ...) WHAT(X, 12) PT_FEC_12(WHAT, __VA_ARGS__)
#define PT_FEC_14(WHAT, X, ...) WHAT(X, 13) PT_FEC_13(WHAT, __VA_ARGS__)
#define PT_FEC_15(WHAT, X, ...) WHAT(X, 14) PT_FEC_14(WHAT, __VA_ARGS__)
#define PT_FEC_16(WHAT, X, ...) WHAT(X, 15) PT_FEC_15(WHAT, __VA_ARGS__)
#define PT_FEC_17(WHAT, X, ...) WHAT(X, 16) PT_FEC_16(WHAT, __VA_ARGS__)
#define PT_FEC_18(WHAT, X, ...) WHAT(X, 17) PT_FEC_17(WHAT, __VA_ARGS__)
#define PT_FEC_19(WHAT, X, ...) WHAT(X, 18) PT_FEC_18(WHAT, __VA_ARGS__)
#define PT_FEC_20(WHAT, X, ...) WHAT(X, 19) PT_FEC_19(WHAT, __VA_ARGS__)
#define PT_FEC_21(WHAT, X, ...) WHAT(X, 20) PT_FEC_20(WHAT, __VA_ARGS__)
#define PT_FEC_22(WHAT, X, ...) WHAT(X, 21) PT_FEC_21(WHAT, __VA_ARGS__)
#define PT_FEC_23(WHAT, X, ...) WHAT(X, 22) PT_FEC_22(WHAT, __VA_ARGS__)
#define PT_FEC_24(WHAT, X, ...) WHAT(X, 23) PT_FEC_23(WHAT, __VA_ARGS__)
#define PT_FEC_25(WHAT, X, ...) WHAT(X, 24) PT_FEC_24(WHAT, __VA_ARGS__)
#define PT_FEC_26(WHAT, X, ...) WHAT(X, 25) PT_FEC_25(WHAT, __VA_ARGS__)
#define PT_FEC_27(WHAT, X, ...) WHAT(X, 26) PT_FEC_26(WHAT, __VA_ARGS__)
#define PT_FEC_28(WHAT, X, ...) WHAT(X, 27) PT_FEC_27(WHAT, __VA_ARGS__)
#define PT_FEC_29(WHAT, X, ...) WHAT(X, 28) PT_FEC_28(WHAT, __VA_ARGS__)
#define PT_FEC_30(WHAT, X, ...) WHAT(X, 29) PT_FEC_29(WHAT, __VA_ARGS__)
#define PT_FEC_31(WHAT, X, ...) WHAT(X, 30) PT_FEC_30(WHAT, __VA_ARGS__)
#define PT_FEC_32(WHAT, X, ...) WHAT(X, 31) PT_FEC_31(WHAT, __VA_ARGS__)
...
#define FOR_EACH_COUNTED(action, ...) \
    GET_MACRO(__VA_ARGS__, PT_FEC_32, PT_FEC_31, \
                           ...
                           PT_FEC_5, PT_FEC_4, PT_FEC_3, PT_FEC_2, PT_FEC_1)(action, __VA_ARGS__)
