...
**
** Created: Wed Apr 25 23:12:34 2012
...
static const char qt_meta_stringdata_Log[] = {
    "Log\0\0str\0newMessage(QString)\0"
    "appendToLog(QString)\0"
};

const QMetaObject Log::staticMetaObject = {
    { &QTextEdit::staticMetaObject, qt_meta_stringdata_Log,
      qt_meta_data_Log, 0 }
};
...
int Log::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: newMessage((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: appendToLog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void Log::newMessage(QString _t1)
{
